...
{
    F->setPen(Qt::black);
    F->drawLine(Data[D].PosReel.L, Data[D].PosReel.C, Data[A].PosReel.L,
		Data[A].PosReel.C);
    F->setPen(Qt::red);
    F->drawText(Data[D].PosStation.L, Data[D].PosStation.C,
		Data[D].Station);
    F->drawText(Data[A].PosStation.L, Data[A].PosStation.C,
		Data[A].Station);

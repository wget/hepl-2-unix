...
QT_BEGIN_NAMESPACE class Ui_Manager {
  public:
	...
	BouttonTerminer->setObjectName(QString::
				       fromUtf8("BouttonTerminer"));
    ...
    } // setupUi void retranslateUi(QMainWindow * Manager) {
	Manager->setWindowTitle(QApplication::translate
				("Manager", "Manager", 0));
	labelV1->setText(QApplication::
			 translate("Manager", "Vehicle 1 :", 0));
	labelV2->setText(QApplication::
			 translate("Manager", "Vehicle 2 :", 0));
	labelV3->setText(QApplication::
			 translate("Manager", "Vehicle 3 :", 0));
	labelMessage->setText(QApplication::
			      translate("Manager", "Message :", 0));
	label_5->setText(QApplication::translate
			 ("Manager", "Nouvelle intervention :", 0));
	BouttonEnregistrer->setText(QApplication::
				    translate("Manager", "Enregistrer",
					      0));
	BouttonTransmettre->setText(QApplication::
				    translate("Manager", "Tranmettre", 0));
	labelMessageRecu->setText(QApplication::translate
				  ("Manager", "Message recu :", 0));
	BouttonFacture->setText(QApplication::
				translate("Manager", "Facturation", 0));
	BouttonTerminer->setText(QApplication::
				 translate("Manager", "Terminer", 0));
    }				// retranslateUi

...
QT_BEGIN_NAMESPACE class Ui_Vehicle {
  public:
	...
	labelMessagePatron->setObjectName(QString::
					  fromUtf8("labelMessagePatron"));
	...
	labelIntervention->setObjectName(QString::
					 fromUtf8("labelIntervention"));
	...
	labelEtat->setAlignment(Qt::AlignRight | Qt::
				AlignTrailing | Qt::AlignVCenter);
	lineMessagePatron = new QLineEdit(centralWidget);
	lineMessagePatron->setObjectName(QString::
					 fromUtf8("lineMessagePatron"));
	...
	lineMessageIntervention->setObjectName(QString::
					       fromUtf8
					       ("lineMessageIntervention"));
    ...
    } // setupUi void retranslateUi(QMainWindow * Vehicle) {
	Vehicle->setWindowTitle(QApplication::translate
				("Vehicle", "Vehicle", 0));
	labelMessagePatron->setText(QApplication::translate
				    ("Vehicle", "Message au patron :", 0));
	labelMessageRecu->setText(QApplication::translate
				  ("Vehicle", "Message recu :", 0));
	labelIntervention->setText(QApplication::translate
				   ("Vehicle", "Intervention chez :", 0));
	labelEtat->setText(QApplication::
			   translate("Vehicle", "TextLabel", 0));
	BouttonPause->setText(QApplication::
			      translate("Vehicle", "Pause", 0));
	BouttonRetour->setText(QApplication::
			       translate("Vehicle", "Retour", 0));
	BouttonEnvoyer->setText(QApplication::
				translate("Vehicle", "Envoyer", 0));
    }				// retranslateUi
